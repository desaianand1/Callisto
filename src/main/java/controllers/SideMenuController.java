...
@ViewController(value = "/view/sideMenu.fxml", title = "Side Menu")
...
//        FlowHandler contentFlowHandler = (FlowHandler) context.getRegisteredObject("innerContentFlowHandler");
...
//            }).start();
//        });
//        Flow contentFlow = (Flow) context.getRegisteredObject("innerFlow");
